...
{{--PAGE TITLE--}}
@section('title', 'Agimo / GDPR Privacy Center - Request Restriction of Processing')
...
@section('subpage-title')
    @lang('restriction.page_title')
@endsection

{{--SUBPAGE DESCRIPTION--}}
@section('subpage-description')
    @lang('restriction.page_description')
@endsection
            ...
            <div class="col-md-9 options-list">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="/data-restriction" method="post">
