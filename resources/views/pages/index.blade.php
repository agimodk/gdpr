                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="option item">
                                ...
                                <a href="/cookies"><button>@lang('index.cookies_button')</button></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="option item">
                                ...
                                <a href="/copyright"><button>@lang('index.copyright_button')</button></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="option item">
                                ...
                                <a href="/media-credits"><button>@lang('index.media_button')</button></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="option item">
                                ...
                                <a href="https://datacvr.virk.dk/data/visenhed?enhedstype=virksomhed&id=40049673"><button>@lang('index.imprint_button')</button></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="option item">
                                ...
                                <a href="/disclaimer"><button>@lang('index.disclaimer_button')</button></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class=" option item">
                                ...
                                <a href="/data-protection-officer"><button>@lang('index.dpo_button')</button></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="option item">
                                ...
                                <a href="/unsubscribe"><button>@lang('index.unsubscribe_button')</button></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="option item">
                                ...
                                <a href="/rectification"><button>@lang('index.rectification_button')</button></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="option item">
                                ...
                                <a href="/forget-me"><button>@lang('index.forget_button')</button></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="option item">
                                ...
                                <a href="/request-data"><button>@lang('index.data_button')</button></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="option item">
                                ...
                                <a href="/access-data"><button>@lang('index.access_button')</button></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="option item">
                                ...
                                <a href="/data-restriction"><button>@lang('index.restriction_button')</button></a>
                            </div>
                        </div>
