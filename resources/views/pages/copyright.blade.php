...
@section('body')
    ...
    @section('subpage-title')
        @lang('dcma.page_title')
    @endsection

    {{--SUBPAGE DESCRIPTION--}}
    @section('subpage-description')
        @lang('dcma.page_description')
    @endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 copyright-form">
                            ...
                            <form action="/dcma" method="post">
                                ...
                                <button class="send-message disabled-button" disabled><i class="far fa-paper-plane"></i>@lang('dcma.send_notice')</button>
